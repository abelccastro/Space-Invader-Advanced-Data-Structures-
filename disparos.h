...
bool elimina_bala_objeto(struct NAVE& N, struct NAVE& E, struct Balas B[]);///esta es la funcion de las colisiones para eliminar bala cuando se encuentra con enemigo
